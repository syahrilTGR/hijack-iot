...
// Fungsi ini tetap sama, tapi karena objek `gps` tidak pernah diupdate,
// ia akan mengirimkan waktu dan lokasi dummy secara default.
...
void sendPacket(float tempLingkungan, float tempTubuh, bool emergency = false) {
  ...
  // Karena GPS tidak aktif, data lat/lon akan selalu 0
